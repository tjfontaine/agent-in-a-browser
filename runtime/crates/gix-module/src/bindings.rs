...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_gix_module_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_gix_module_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:shell:unix@0.1.0:gix-module:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 4879] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x8e%\x01A\x02\x01A\x15\
...
\x04\0\x1bshell:unix/gix-module@0.1.0\x04\0\x0b\x10\x01\0\x0agix-module\x03\0\0\0\
