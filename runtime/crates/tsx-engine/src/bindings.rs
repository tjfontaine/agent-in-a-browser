...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:shell:unix@0.1.0:tsx-engine:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 15346] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xf1v\x01A\x02\x01AI\x01\
...
:sockets/ip-name-lookup@0.2.9\x05,\x01B\x0f\x02\x03\x02\x01\x06\x04\0\x0cinput-s\
tream\x03\0\0\x02\x03\x02\x01\x07\x04\0\x0doutput-stream\x03\0\x02\x01o\x02ss\x01\
p\x04\x01r\x02\x03cwds\x04vars\x05\x04\0\x08exec-env\x03\0\x06\x01ps\x01i\x01\x01\
...
\x18shell:unix/command@0.1.0\x05-\x04\0\x1bshell:unix/tsx-engine@0.1.0\x04\0\x0b\
