        ...
        pub mod location {
            ...
            pub fn reverse_geocode(lat: f64, lng: f64) -> _rt::String {
                unsafe {
                    ...
                    #[cfg(not(target_arch = "wasm32"))]
                    unsafe extern "C" fn wit_import1(_: f64, _: f64, _: *mut u8) {
                        unreachable!()
                    }
            ...
            impl Fields {
                ...
                pub fn has(&self, name: &str) -> bool {
                    unsafe {
                        ...
                        #[cfg(not(target_arch = "wasm32"))]
                        unsafe extern "C" fn wit_import1(_: i32, _: *mut u8, _: usize) -> i32 {
                            unreachable!()
                        }
            ...
            impl OutgoingRequest {
                ...
                pub fn set_method(&self, method: &Method) -> Result<(), ()> {
                    unsafe {
                        ...
                        let ret =
                            wit_import2((self).handle() as i32, result1_0, result1_1, result1_2);
                        match ret {
                            0 => {
                                let e = ();
                                Ok(e)
            ...
            pub fn poll(in_: &[&Pollable]) -> _rt::Vec<u32> {
                unsafe {
                    ...
                    let l4 = *ptr1
                        ...
                        .cast::<usize>();
                    let len5 = l4;
                    let result6 = <_ as From<_rt::Vec<_>>>::from(_rt::Vec::from_raw_parts(
                        l3.cast(),
                        len5,
                        len5,
                    ));
        ...
        ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
          ...
          unsafe extern "C" fn _post_return_list_commands(arg0: *mut u8,) {
            ...
            pub mod eval {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case, unused_unsafe)]
                pub unsafe fn _export_eval_file_cabi<T: Guest>(
                    arg0: *mut u8,
                    arg1: usize,
                    arg2: *mut u8,
                    arg3: usize,
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_eval_file<T: Guest>(arg0: *mut u8) {
                    unsafe {
                        let l0 = i32::from(*arg0.add(0).cast::<u8>());
                        match l0 {
                            0 => {
