...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:shell:unix@0.1.0:brush-shell:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1549] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x8b\x0b\x01A\x02\x01\
...
l:unix/command@0.1.0\x05\x07\x04\0\x1cshell:unix/brush-shell@0.1.0\x04\0\x0b\x11\
\x01\0\x0bbrush-shell\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-com\
