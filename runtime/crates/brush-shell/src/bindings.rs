  ...
  pub mod module_loader {
    ...
    pub mod loader {
      ...
      impl ::core::fmt::Debug for TerminalSize {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
          f.debug_struct("TerminalSize").field("cols", &self.cols).field("rows", &self.rows).finish()
        }
      }
      ...
      pub struct LazyProcess{
        handle: _rt::Resource<LazyProcess>,
      }
      ...
      unsafe impl _rt::WasmResource for LazyProcess{
        #[inline]
        unsafe fn drop(_handle: u32) {
          ...
          unsafe extern "C" {
            #[link_name = "[resource-drop]lazy-process"]
            fn drop(_: i32, );
          }
      ...
      impl LazyProcess {
        ...
        pub fn get_ready_pollable(&self,) -> Pollable{
          unsafe {

            #[cfg(target_arch = "wasm32")]
            #[link(wasm_import_module = "mcp:module-loader/loader@0.1.0")]
            unsafe extern "C" {
              #[link_name = "[method]lazy-process.get-ready-pollable"]
      ...
      impl LazyProcess {
        ...
        pub fn is_ready(&self,) -> bool{
          unsafe {
            ...
            #[link(wasm_import_module = "mcp:module-loader/loader@0.1.0")]
            unsafe extern "C" {
              #[link_name = "[method]lazy-process.is-ready"]
              fn wit_import0(_: i32, ) -> i32;
            }
      ...
      impl LazyProcess {
        ...
        pub fn write_stdin(&self,data: &[u8],) -> u64{
          unsafe {
            ...
            #[link(wasm_import_module = "mcp:module-loader/loader@0.1.0")]
            unsafe extern "C" {
              #[link_name = "[method]lazy-process.write-stdin"]
              fn wit_import1(_: i32, _: *mut u8, _: usize, ) -> i64;
            }

            #[cfg(not(target_arch = "wasm32"))]
            unsafe extern "C" fn wit_import1(_: i32, _: *mut u8, _: usize, ) -> i64 { unreachable!() }
      ...
      impl LazyProcess {
        ...
        pub fn close_stdin(&self,) -> (){
          unsafe {
            ...
            #[link(wasm_import_module = "mcp:module-loader/loader@0.1.0")]
            unsafe extern "C" {
              #[link_name = "[method]lazy-process.close-stdin"]
      ...
      impl LazyProcess {
        ...
        pub fn read_stderr(&self,max_bytes: u64,) -> _rt::Vec::<u8>{
          unsafe {
            ...
            #[link(wasm_import_module = "mcp:module-loader/loader@0.1.0")]
            unsafe extern "C" {
              #[link_name = "[method]lazy-process.read-stderr"]
              fn wit_import1(_: i32, _: i64, _: *mut u8, );
            }
      ...
      impl LazyProcess {
        ...
        pub fn try_wait(&self,) -> Option<i32>{
          unsafe {
            ...
            #[link(wasm_import_module = "mcp:module-loader/loader@0.1.0")]
            unsafe extern "C" {
              #[link_name = "[method]lazy-process.try-wait"]
      ...
      impl LazyProcess {
        ...
        pub fn set_terminal_size(&self,size: TerminalSize,) -> (){
          unsafe {
            ...
            wit_import1((self).handle() as i32, _rt::as_i32(cols0), _rt::as_i32(rows0));
          }
        }
      }
      impl LazyProcess {
        ...
        pub fn set_raw_mode(&self,enabled: bool,) -> (){
          unsafe {
            ...
            wit_import0((self).handle() as i32, match &enabled { true => 1, false => 0 });
          }
        }
      }
      impl LazyProcess {
      ...
      #[allow(async_fn_in_trait)]
      pub fn spawn_lazy_command(module: &str,command: &str,args: &[_rt::String],env: &ExecEnv,) -> LazyProcess{
        unsafe {
          let vec0 = module;
          let ptr0 = vec0.as_ptr().cast::<u8>();
          let len0 = vec0.len();
          ...
          let vec9 = vars4;
          let len9 = vec9.len();
          let layout9 = _rt::alloc::Layout::from_size_align(vec9.len() * (4*::core::mem::size_of::<*const u8>()), ::core::mem::size_of::<*const u8>()).unwrap();
          let (result9, _cleanup9) = wit_bindgen::rt::Cleanup::new(layout9);for (i, e) in vec9.into_iter().enumerate() {
            let base = result9.add(i * (4*::core::mem::size_of::<*const u8>()));
            {
              let (t6_0, t6_1, ) = e;
              let vec7 = t6_0;
          ...
          #[link(wasm_import_module = "mcp:module-loader/loader@0.1.0")]
          unsafe extern "C" {
            #[link_name = "spawn-lazy-command"]
            fn wit_import10(_: *mut u8, _: usize, _: *mut u8, _: usize, _: *mut u8, _: usize, _: *mut u8, _: usize, _: *mut u8, _: usize, ) -> i32;
          }

          #[cfg(not(target_arch = "wasm32"))]
          unsafe extern "C" fn wit_import10(_: *mut u8, _: usize, _: *mut u8, _: usize, _: *mut u8, _: usize, _: *mut u8, _: usize, _: *mut u8, _: usize, ) -> i32 { unreachable!() }
          let ret = wit_import10(ptr0.cast_mut(), len0, ptr1.cast_mut(), len1, result3, len3, ptr5.cast_mut(), len5, result9, len9);
          LazyProcess::from_handle(ret as u32)
        }
      }
      #[allow(unused_unsafe, clippy::all)]
      ...
      #[allow(async_fn_in_trait)]
      pub fn spawn_interactive(module: &str,command: &str,args: &[_rt::String],env: &ExecEnv,size: TerminalSize,) -> LazyProcess{
        unsafe {
          let vec0 = module;
          let ptr0 = vec0.as_ptr().cast::<u8>();
          let len0 = vec0.len();
          ...
          unsafe extern "C" {
            ...
            fn wit_import11(_: *mut u8, _: usize, _: *mut u8, _: usize, _: *mut u8, _: usize, _: *mut u8, _: usize, _: *mut u8, _: usize, _: i32, _: i32, ) -> i32;
          }

          #[cfg(not(target_arch = "wasm32"))]
          unsafe extern "C" fn wit_import11(_: *mut u8, _: usize, _: *mut u8, _: usize, _: *mut u8, _: usize, _: *mut u8, _: usize, _: *mut u8, _: usize, _: i32, _: i32, ) -> i32 { unreachable!() }
          let ret = wit_import11(ptr0.cast_mut(), len0, ptr1.cast_mut(), len1, result3, len3, ptr5.cast_mut(), len5, result9, len9, _rt::as_i32(cols10), _rt::as_i32(rows10));
          LazyProcess::from_handle(ret as u32)
        }
      }
...
macro_rules! __export_brush_shell_impl {
...
#[doc(inline)]
pub(crate) use __export_brush_shell_impl as export;

#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.50.0:shell:unix@0.1.0:brush-shell:encoded world")]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 2473] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xa7\x12\x01A\x02\x01\
A\x0e\x01B\x04\x04\0\x05error\x03\x01\x01h\0\x01@\x01\x04self\x01\0s\x04\0\x1d[m\
...
\x18\x03\0\x15wasi:io/streams@0.2.4\x05\x04\x01B,\x02\x03\x02\x01\x03\x04\0\x08p\
ollable\x03\0\0\x01o\x02ss\x01p\x02\x01r\x02\x03cwds\x04vars\x03\x04\0\x08exec-e\
nv\x03\0\x04\x01r\x02\x04colsy\x04rowsy\x04\0\x0dterminal-size\x03\0\x06\x04\0\x0c\
lazy-process\x03\x01\x01h\x08\x01i\x01\x01@\x01\x04self\x09\0\x0a\x04\0'[method]\
lazy-process.get-ready-pollable\x01\x0b\x01@\x01\x04self\x09\0\x7f\x04\0\x1d[met\
hod]lazy-process.is-ready\x01\x0c\x01p}\x01@\x02\x04self\x09\x04data\x0d\0w\x04\0\
\x20[method]lazy-process.write-stdin\x01\x0e\x01@\x01\x04self\x09\x01\0\x04\0\x20\
[method]lazy-process.close-stdin\x01\x0f\x01@\x02\x04self\x09\x09max-bytesw\0\x0d\
\x04\0\x20[method]lazy-process.read-stdout\x01\x10\x04\0\x20[method]lazy-process\
.read-stderr\x01\x10\x01kz\x01@\x01\x04self\x09\0\x11\x04\0\x1d[method]lazy-proc\
ess.try-wait\x01\x12\x01@\x01\x04self\x09\0\x07\x04\0&[method]lazy-process.get-t\
erminal-size\x01\x13\x01@\x02\x04self\x09\x04size\x07\x01\0\x04\0&[method]lazy-p\
rocess.set-terminal-size\x01\x14\x01@\x02\x04self\x09\x07enabled\x7f\x01\0\x04\0\
![method]lazy-process.set-raw-mode\x01\x15\x04\0\x20[method]lazy-process.is-raw-\
mode\x01\x0c\x01@\x02\x04self\x09\x06signum}\x01\0\x04\0\x20[method]lazy-process\
.send-signal\x01\x16\x01ks\x01@\x01\x07commands\0\x17\x04\0\x0fget-lazy-module\x01\
\x18\x01ps\x01i\x08\x01@\x04\x06modules\x07commands\x04args\x19\x03env\x05\0\x1a\
\x04\0\x12spawn-lazy-command\x01\x1b\x01@\x05\x06modules\x07commands\x04args\x19\
\x03env\x05\x04size\x07\0\x1a\x04\0\x11spawn-interactive\x01\x1c\x03\0\x1emcp:mo\
dule-loader/loader@0.1.0\x05\x05\x02\x03\0\x02\x0cinput-stream\x02\x03\0\x02\x0d\
output-stream\x01B\x0f\x02\x03\x02\x01\x06\x04\0\x0cinput-stream\x03\0\0\x02\x03\
\x02\x01\x07\x04\0\x0doutput-stream\x03\0\x02\x01o\x02ss\x01p\x04\x01r\x02\x03cw\
ds\x04vars\x05\x04\0\x08exec-env\x03\0\x06\x01ps\x01i\x01\x01i\x03\x01@\x06\x04n\
ames\x04args\x08\x03env\x07\x05stdin\x09\x06stdout\x0a\x06stderr\x0a\0z\x04\0\x03\
run\x01\x0b\x01@\0\0\x08\x04\0\x0dlist-commands\x01\x0c\x04\0\x18shell:unix/comm\
and@0.1.0\x05\x08\x04\0\x1cshell:unix/brush-shell@0.1.0\x04\0\x0b\x11\x01\0\x0bb\
rush-shell\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070\
.243.0\x10wit-bindgen-rust\x060.50.0";
