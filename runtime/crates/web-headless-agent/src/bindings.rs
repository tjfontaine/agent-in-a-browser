...
impl ::core::fmt::Debug for McpServerConfig {
...
pub struct ProviderInfo {
    ...
    pub name: _rt::String,
    /// Default base URL (empty if using provider's built-in default)
    pub default_base_url: Option<_rt::String>,
}
impl ::core::fmt::Debug for ProviderInfo {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("ProviderInfo")
            .field("id", &self.id)
            .field("name", &self.name)
            .field("default-base-url", &self.default_base_url)
            .finish()
    }
}
...
impl ::core::fmt::Debug for AgentConfig {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("AgentConfig")
            ...
            .field("preamble-override", &self.preamble_override)
            .field("mcp-servers", &self.mcp_servers)
            .field("max-turns", &self.max_turns)
            .finish()
    }
}
/// Message role
...
impl ::core::fmt::Debug for MessageRole {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        match self {
            ...
            MessageRole::Assistant => f.debug_tuple("MessageRole::Assistant").finish(),
        }
    }
}
impl MessageRole {
...
impl ::core::fmt::Debug for ToolResultData {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("ToolResultData")
            .field("name", &self.name)
...
impl ::core::fmt::Debug for TaskUpdateInfo {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("TaskUpdateInfo")
            .field("id", &self.id)
...
impl ::core::fmt::Debug for TaskCompleteInfo {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("TaskCompleteInfo")
            .field("id", &self.id)
...
/// Model loading progress for local LLM providers (e.g., WebLLM)
#[derive(Clone)]
pub struct ModelLoadingProgress {
    /// Human-readable progress text (e.g., "Downloading model weights...")
    pub text: _rt::String,
    /// Progress percentage (0.0 to 1.0)
    pub progress: f32,
}
impl ::core::fmt::Debug for ModelLoadingProgress {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("ModelLoadingProgress")
...
pub enum AgentEvent {
    /// Stream events
    StreamStart,
    StreamChunk(_rt::String),
    StreamComplete(_rt::String),
    StreamError(_rt::String),
    /// Tool events
    ToolCall(_rt::String),
    ToolResult(ToolResultData),
    /// Task lifecycle events for task-based UI
    PlanGenerated(_rt::String),
    /// plan.md content
    TaskStart(TaskInfo),
    /// task beginning
    TaskUpdate(TaskUpdateInfo),
    /// progress update
    TaskComplete(TaskCompleteInfo),
    /// task done
    /// Model loading events (for local LLM providers like WebLLM)
    ModelLoading(ModelLoadingProgress),
    /// State
    Ready,
}
impl ::core::fmt::Debug for AgentEvent {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        match self {
            AgentEvent::StreamStart => f.debug_tuple("AgentEvent::StreamStart").finish(),
            ...
            AgentEvent::ModelLoading(e) => {
                f.debug_tuple("AgentEvent::ModelLoading").field(e).finish()
            }
            AgentEvent::Ready => f.debug_tuple("AgentEvent::Ready").finish(),
        }
    }
}
/// Agent handle (opaque identifier)
pub type AgentHandle = u32;
#[doc(hidden)]
        ...
        mcp_servers: match l21 {
            ...
            1 => {
                let e = {
                    ...
                    _rt::cabi_dealloc(
                        base31,
                        len31 * (5 * ::core::mem::size_of::<*const u8>()),
            ...
            match e {
                ...
                AgentEvent::ToolResult(e) => {
                    ...
                    *ptr1
                    ...
                    let vec8 = (output6.into_bytes()).into_boxed_slice();
                ...
                AgentEvent::TaskStart(e) => {
                    *ptr1.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (7i32) as u8;
                    ...
                    let vec11 = (id10.into_bytes()).into_boxed_slice();
                    ...
                    *ptr1
                    ...
                    let vec13 = (description10.into_bytes()).into_boxed_slice();
                ...
                AgentEvent::TaskUpdate(e) => {
                    ...
                    *ptr1
                    ...
                    let vec16 = (status14.into_bytes()).into_boxed_slice();
                ...
                AgentEvent::TaskComplete(e) => {
                    *ptr1.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (9i32) as u8;
                    ...
                    let vec18 = (id17.into_bytes()).into_boxed_slice();
...
pub unsafe fn _export_list_providers_cabi<T: Guest>() -> *mut u8 {
    ...
    for (i, e) in vec6.into_iter().enumerate() {
        let base = result6.add(i * (7 * ::core::mem::size_of::<*const u8>()));
        {
            let ProviderInfo {
                id: id2,
                name: name2,
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn _export_fetch_models_cabi<T: Guest>(
    arg0: *mut u8,
    arg1: usize,
    arg2: *mut u8,
    arg3: usize,
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn __post_return_fetch_models<T: Guest>(arg0: *mut u8) {
    let l0 = i32::from(*arg0.add(0).cast::<u8>());
    match l0 {
        0 => {
            let l1 = *arg0
...
pub trait Guest {
    ...
    /// Streaming API
    fn send_message(handle: AgentHandle, message: _rt::String) -> Result<(), _rt::String>;
    ...
    fn plan(handle: AgentHandle, message: _rt::String) -> Result<(), _rt::String>;
    /// Execution phase - sends "execute" action
    /// Agent should read /plan.md and execute all steps
    fn execute(handle: AgentHandle) -> Result<(), _rt::String>;
    /// History management
    fn get_history(handle: AgentHandle) -> _rt::Vec<Message>;
    fn clear_history(handle: AgentHandle) -> ();
    /// Provider/Model discovery (no agent required)
    /// Get list of available AI providers
    fn list_providers() -> _rt::Vec<ProviderInfo>;
    /// Get static list of models for a provider (no API key required)
    fn list_models(provider_id: _rt::String) -> _rt::Vec<ModelInfo>;
    /// Fetch models from provider API (requires API key)
    /// Returns fresh model list from the provider's API
    fn fetch_models(
        provider_id: _rt::String,
        api_key: _rt::String,
        base_url: Option<_rt::String>,
    ) -> Result<_rt::Vec<ModelInfo>, _rt::String>;
}
#[doc(hidden)]
macro_rules! __export_world_headless_agent_cabi {
    ($ty:ident with_types_in $($path_to_types:tt)*) => {
        const _ : () = { #[unsafe (export_name = "create")] unsafe extern "C" fn
        export_create(arg0 : * mut u8,) -> * mut u8 { unsafe { $($path_to_types)*::
        _export_create_cabi::<$ty > (arg0) } } #[unsafe (export_name =
        "cabi_post_create")] unsafe extern "C" fn _post_return_create(arg0 : * mut u8,) {
        ...
        * mut u8,) { unsafe { $($path_to_types)*:: __post_return_send_message::<$ty >
        ...
        $($path_to_types)*:: _export_get_history_cabi::<$ty > (arg0) } } #[unsafe
        (export_name = "cabi_post_get-history")] unsafe extern "C" fn
        _post_return_get_history(arg0 : * mut u8,) { unsafe { $($path_to_types)*::
        __post_return_get_history::<$ty > (arg0) } } #[unsafe (export_name =
        "clear-history")] unsafe extern "C" fn export_clear_history(arg0 : i32,) { unsafe
        { $($path_to_types)*:: _export_clear_history_cabi::<$ty > (arg0) } } #[unsafe
        (export_name = "list-providers")] unsafe extern "C" fn export_list_providers() ->
        * mut u8 { unsafe { $($path_to_types)*:: _export_list_providers_cabi::<$ty > () }
        } #[unsafe (export_name = "cabi_post_list-providers")] unsafe extern "C" fn
        _post_return_list_providers(arg0 : * mut u8,) { unsafe { $($path_to_types)*::
        __post_return_list_providers::<$ty > (arg0) } } #[unsafe (export_name =
        "list-models")] unsafe extern "C" fn export_list_models(arg0 : * mut u8, arg1 :
        usize,) -> * mut u8 { unsafe { $($path_to_types)*::
        _export_list_models_cabi::<$ty > (arg0, arg1) } } #[unsafe (export_name =
        "cabi_post_list-models")] unsafe extern "C" fn _post_return_list_models(arg0 : *
        mut u8,) { unsafe { $($path_to_types)*:: __post_return_list_models::<$ty > (arg0)
        } } #[unsafe (export_name = "fetch-models")] unsafe extern "C" fn
        export_fetch_models(arg0 : * mut u8, arg1 : usize, arg2 : * mut u8, arg3 : usize,
        arg4 : i32, arg5 : * mut u8, arg6 : usize,) -> * mut u8 { unsafe {
        $($path_to_types)*:: _export_fetch_models_cabi::<$ty > (arg0, arg1, arg2, arg3,
        arg4, arg5, arg6) } } #[unsafe (export_name = "cabi_post_fetch-models")] unsafe
        extern "C" fn _post_return_fetch_models(arg0 : * mut u8,) { unsafe {
        $($path_to_types)*:: __post_return_fetch_models::<$ty > (arg0) } } };
    };
}
#[doc(hidden)]
pub(crate) use __export_world_headless_agent_cabi;
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_headless_agent_impl {
    ($ty:ident) => {
        self::export!($ty with_types_in self);
    };
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*:: __export_world_headless_agent_cabi!($ty with_types_in
        $($path_to_types_root)*);
    };
}
#[doc(inline)]
...
oviders\x05models\x07api-keys\x08base-url\0\x08preamble\0\x11preamble-override\0\
\x0bmcp-servers\x08\x09max-turns\x09\x03\0\x0cagent-config\x03\0\x0a\x01m\x02\x04\
user\x09assistant\x03\0\x0cmessage-role\x03\0\x0c\x01r\x02\x04role\x0d\x07conten\
ts\x03\0\x07message\x03\0\x0e\x01r\x03\x04names\x06outputs\x08is-error\x7f\x03\0\
\x10tool-result-data\x03\0\x10\x01r\x03\x02ids\x04names\x0bdescriptions\x03\0\x09\
task-info\x03\0\x12\x01r\x03\x02ids\x06statuss\x08progress\x09\x03\0\x10task-upd\
ate-info\x03\0\x14\x01r\x03\x02ids\x07success\x7f\x06output\0\x03\0\x12task-comp\
lete-info\x03\0\x16\x01r\x02\x04texts\x08progressv\x03\0\x16model-loading-progre\
ss\x03\0\x18\x01q\x0c\x0cstream-start\0\0\x0cstream-chunk\x01s\0\x0fstream-compl\
ete\x01s\0\x0cstream-error\x01s\0\x09tool-call\x01s\0\x0btool-result\x01\x11\0\x0e\
plan-generated\x01s\0\x0atask-start\x01\x13\0\x0btask-update\x01\x15\0\x0dtask-c\
omplete\x01\x17\0\x0dmodel-loading\x01\x19\0\x05ready\0\0\x03\0\x0bagent-event\x03\
\0\x1a\x01y\x03\0\x0cagent-handle\x03\0\x1c\x01B\x04\x04\0\x05error\x03\x01\x01h\
\0\x01@\x01\x04self\x01\0s\x04\0\x1d[method]error.to-debug-string\x01\x02\x03\0\x13\
wasi:io/error@0.2.9\x05\x1e\x01B\x0a\x04\0\x08pollable\x03\x01\x01h\0\x01@\x01\x04\
...
\x04\0\x04poll\x01\x06\x03\0\x12wasi:io/poll@0.2.9\x05\x1f\x02\x03\0\0\x05error\x02\
\x03\0\x01\x08pollable\x01B(\x02\x03\x02\x01\x20\x04\0\x05error\x03\0\0\x02\x03\x02\
\x01!\x04\0\x08pollable\x03\0\x02\x01i\x01\x01q\x02\x15last-operation-failed\x01\
...
\0%[method]output-stream.blocking-splice\x01\x18\x03\0\x15wasi:io/streams@0.2.9\x05\
\"\x01B\x0f\x02\x03\x02\x01!\x04\0\x08pollable\x03\0\0\x01w\x04\0\x07instant\x03\
...
\x01\x0a\x03\0!wasi:clocks/monotonic-clock@0.2.9\x05#\x02\x03\0\x03\x08duration\x02\
\x03\0\x02\x0cinput-stream\x02\x03\0\x02\x0doutput-stream\x01B\xc1\x01\x02\x03\x02\
\x01$\x04\0\x08duration\x03\0\0\x02\x03\x02\x01%\x04\0\x0cinput-stream\x03\0\x02\
\x02\x03\x02\x01&\x04\0\x0doutput-stream\x03\0\x04\x02\x03\x02\x01\x20\x04\0\x08\
io-error\x03\0\x06\x02\x03\x02\x01!\x04\0\x08pollable\x03\0\x08\x01q\x0a\x03get\0\
\0\x04head\0\0\x04post\0\0\x03put\0\0\x06delete\0\0\x07connect\0\0\x07options\0\0\
\x05trace\0\0\x05patch\0\0\x05other\x01s\0\x04\0\x06method\x03\0\x0a\x01q\x03\x04\
HTTP\0\0\x05HTTPS\0\0\x05other\x01s\0\x04\0\x06scheme\x03\0\x0c\x01ks\x01k{\x01r\
\x02\x05rcode\x0e\x09info-code\x0f\x04\0\x11DNS-error-payload\x03\0\x10\x01k}\x01\
...
'\x02\x03\0\x04\x10outgoing-request\x02\x03\0\x04\x0frequest-options\x02\x03\0\x04\
\x18future-incoming-response\x02\x03\0\x04\x0aerror-code\x01B\x0f\x02\x03\x02\x01\
(\x04\0\x10outgoing-request\x03\0\0\x02\x03\x02\x01)\x04\0\x0frequest-options\x03\
\0\x02\x02\x03\x02\x01*\x04\0\x18future-incoming-response\x03\0\x04\x02\x03\x02\x01\
+\x04\0\x0aerror-code\x03\0\x06\x01i\x01\x01i\x03\x01k\x09\x01i\x05\x01j\x01\x0b\
\x01\x07\x01@\x02\x07request\x08\x07options\x0a\0\x0c\x04\0\x06handle\x01\x0d\x03\
\0\x20wasi:http/outgoing-handler@0.2.9\x05,\x01B\x05\x01r\x02\x07secondsw\x0bnan\
osecondsy\x04\0\x08datetime\x03\0\0\x01@\0\0\x01\x04\0\x03now\x01\x02\x04\0\x0ar\
esolution\x01\x02\x03\0\x1cwasi:clocks/wall-clock@0.2.9\x05-\x01B\x03\x01o\x02ww\
