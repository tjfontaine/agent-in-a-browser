    ...
    pub mod size {
      ...
      impl ::core::fmt::Debug for Dimensions {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
          f.debug_struct("Dimensions").field("cols", &self.cols).field("rows", &self.rows).finish()
        }
      }
...
macro_rules! __export_edtui_module_impl {
...
#[doc(inline)]
pub(crate) use __export_edtui_module_impl as export;

#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.50.0:shell:unix@0.1.0:edtui-module:encoded world")]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 5167] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xac'\x01A\x02\x01A\x19\
...
\x01\x0a\x03\0!wasi:clocks/monotonic-clock@0.2.4\x05\x0d\x01B\x04\x01r\x02\x04co\
ls{\x04rows{\x04\0\x0adimensions\x03\0\0\x01@\0\0\x01\x04\0\x11get-terminal-size\
\x01\x02\x03\0\x18terminal:info/size@0.1.0\x05\x0e\x01B\x0f\x02\x03\x02\x01\x06\x04\
...
\x04\0\x18shell:unix/command@0.1.0\x05\x0f\x04\0\x1dshell:unix/edtui-module@0.1.\
0\x04\0\x0b\x12\x01\0\x0cedtui-module\x03\0\0\0G\x09producers\x01\x0cprocessed-b\
y\x02\x0dwit-component\x070.243.0\x10wit-bindgen-rust\x060.50.0";
