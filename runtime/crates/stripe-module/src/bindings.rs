...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_stripe_module_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_stripe_module_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:shell:unix@0.1.0:stripe-module:encoded world"
)]
#[doc(hidden)]
