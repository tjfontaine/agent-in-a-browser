 ...
 * Extends ReadyPollable (from wasi-shims) which extends Pollable from poll-impl.js.
 * This ensures JCO instanceof checks pass since all Pollable subclasses share the same base.
 */
