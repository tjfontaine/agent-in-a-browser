...
import { request, responseBodyRead, responseClose, responseHeaders, responseStatus } from '@tjfontaine/wasi-shims/http-bridge-impl.js';
import { preopens, types } from '@tjfontaine/wasi-shims/opfs-filesystem-impl.js';
import { Pollable, poll } from '@tjfontaine/wasi-shims/poll-impl.js';
import { random } from '@tjfontaine/wasi-shims/random.js';
...
function trampoline0(arg0) {
  _debugLog('[iface="stripe:bridge/http-bridge@0.1.0", function="response-status"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'response-status');
  const ret = responseStatus(arg0 >>> 0);
  _debugLog('[iface="stripe:bridge/http-bridge@0.1.0", function="response-status"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  _debugLog('[iface="stripe:bridge/http-bridge@0.1.0", function="response-status"][Instruction::Return]', {
    funcName: 'response-status',
    paramCount: 1,
    async: false,
    postReturn: false
  });
...
function trampoline1(arg0) {
  _debugLog('[iface="stripe:bridge/http-bridge@0.1.0", function="response-close"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'response-close');
  responseClose(arg0 >>> 0);
  _debugLog('[iface="stripe:bridge/http-bridge@0.1.0", function="response-close"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  _debugLog('[iface="stripe:bridge/http-bridge@0.1.0", function="response-close"][Instruction::Return]', {
    funcName: 'response-close',
    paramCount: 0,
    async: false,
    postReturn: false
  });
...
function trampoline11(arg0) {
  _debugLog('[iface="wasi:clocks/monotonic-clock@0.2.6", function="subscribe-instant"] [Instruction::CallInterface] (async? sync, @ enter)');
  ...
  _debugLog('[iface="wasi:clocks/monotonic-clock@0.2.6", function="subscribe-instant"][Instruction::Return]', {
...
const trampoline19 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7) {
  var ptr0 = arg0;
  var len0 = arg1;
  ...
  _debugLog('[iface="stripe:bridge/http-bridge@0.1.0", function="request"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'request');
  const ret = await request(result0, result1, result2, result3);
  _debugLog('[iface="stripe:bridge/http-bridge@0.1.0", function="request"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  _debugLog('[iface="stripe:bridge/http-bridge@0.1.0", function="request"][Instruction::Return]', {
    funcName: 'request',
    paramCount: 1,
    async: false,
    postReturn: false
...
function trampoline20(arg0, arg1) {
  _debugLog('[iface="stripe:bridge/http-bridge@0.1.0", function="response-headers"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'response-headers');
  const ret = responseHeaders(arg0 >>> 0);
  _debugLog('[iface="stripe:bridge/http-bridge@0.1.0", function="response-headers"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  var ptr0 = utf8Encode(ret, realloc0, memory0);
  var len0 = utf8EncodedLen;
  dataView(memory0).setUint32(arg1 + 4, len0, true);
  dataView(memory0).setUint32(arg1 + 0, ptr0, true);
  _debugLog('[iface="stripe:bridge/http-bridge@0.1.0", function="response-headers"][Instruction::Return]', {
    funcName: 'response-headers',
    paramCount: 0,
    async: false,
    postReturn: false
  });
...
function trampoline21(arg0, arg1, arg2) {
  _debugLog('[iface="stripe:bridge/http-bridge@0.1.0", function="response-body-read"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'response-body-read');
  const ret = responseBodyRead(arg0 >>> 0, arg1 >>> 0);
  _debugLog('[iface="stripe:bridge/http-bridge@0.1.0", function="response-body-read"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  var val0 = ret;
  ...
  dataView(memory0).setUint32(arg2 + 4, len0, true);
  dataView(memory0).setUint32(arg2 + 0, ptr0, true);
  _debugLog('[iface="stripe:bridge/http-bridge@0.1.0", function="response-body-read"][Instruction::Return]', {
    funcName: 'response-body-read',
    paramCount: 0,
    async: false,
    postReturn: false
  });
...
const trampoline26 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3) {
  var handle1 = arg0;
  var rep2 = handleTable7[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable7.get(rep2);
  if (!rsc0) {
  ...
  let ret;
  try {
    ret = { tag: 'ok', val: await rsc0.read(BigInt.asUintN(64, arg1), BigInt.asUintN(64, arg2))};
  } catch (e) {
    ret = { tag: 'err', val: getErrorPayload(e) };
  }
...
const trampoline27 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4) {
  var handle1 = arg0;
  var rep2 = handleTable7[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable7.get(rep2);
  if (!rsc0) {
  ...
  let ret;
  try {
    ret = { tag: 'ok', val: await rsc0.write(result3, BigInt.asUintN(64, arg3))};
  } catch (e) {
    ret = { tag: 'err', val: getErrorPayload(e) };
  }
...
const trampoline28 = new WebAssembly.Suspending(async function(arg0, arg1) {
  var handle1 = arg0;
  var rep2 = handleTable7[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable7.get(rep2);
  if (!rsc0) {
...
function trampoline29(arg0, arg1) {
  ...
  curResourceBorrows.push(rsc0);
  _debugLog('[iface="wasi:filesystem/types@0.2.6", function="[method]descriptor.sync"] [Instruction::CallInterface] (async? sync, @ enter)');
  ...
  _debugLog('[iface="wasi:filesystem/types@0.2.6", function="[method]descriptor.sync"] [Instruction::CallInterface] (sync, @ post-call)');
  for (const rsc of curResourceBorrows) {
    rsc[symbolRscHandle] = undefined;
  }
  curResourceBorrows = [];
  ...
  _debugLog('[iface="wasi:filesystem/types@0.2.6", function="[method]descriptor.sync"][Instruction::Return]', {
...
const trampoline30 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3) {
  var handle1 = arg0;
  var rep2 = handleTable7[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable7.get(rep2);
  if (!rsc0) {
...
const trampoline31 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4) {
  var handle1 = arg0;
  var rep2 = handleTable7[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable7.get(rep2);
  if (!rsc0) {
...
function trampoline32(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10) {
  var handle1 = arg0;
  var rep2 = handleTable7[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable7.get(rep2);
  if (!rsc0) {
  ...
  _debugLog('[iface="wasi:filesystem/types@0.2.6", function="[method]descriptor.set-times-at"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, '[method]descriptor.set-times-at');
  let ret;
  try {
  ...
  _debugLog('[iface="wasi:filesystem/types@0.2.6", function="[method]descriptor.set-times-at"] [Instruction::CallInterface] (sync, @ post-call)');
  for (const rsc of curResourceBorrows) {
    rsc[symbolRscHandle] = undefined;
  }
  curResourceBorrows = [];
  ...
  _debugLog('[iface="wasi:filesystem/types@0.2.6", function="[method]descriptor.set-times-at"][Instruction::Return]', {
...
const trampoline33 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
  var handle1 = arg0;
  var rep2 = handleTable7[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable7.get(rep2);
  if (!rsc0) {
...
const trampoline34 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3) {
  var handle1 = arg0;
  var rep2 = handleTable7[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable7.get(rep2);
  if (!rsc0) {
...
const trampoline35 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
  var handle1 = arg0;
  var rep2 = handleTable7[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable7.get(rep2);
  if (!rsc0) {
...
const trampoline36 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3, arg4, arg5) {
  var handle1 = arg0;
  var rep2 = handleTable7[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable7.get(rep2);
  if (!rsc0) {
  ...
  var len4 = arg4;
  var result4 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr4, len4));
  _debugLog('[iface="wasi:filesystem/types@0.2.6", function="[method]descriptor.symlink-at"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, '[method]descriptor.symlink-at');
  let ret;
  try {
    ret = { tag: 'ok', val: await rsc0.symlinkAt(result3, result4)};
  } catch (e) {
    ret = { tag: 'err', val: getErrorPayload(e) };
  }
  _debugLog('[iface="wasi:filesystem/types@0.2.6", function="[method]descriptor.symlink-at"] [Instruction::CallInterface] (sync, @ post-call)');
  for (const rsc of curResourceBorrows) {
    rsc[symbolRscHandle] = undefined;
  }
  curResourceBorrows = [];
  ...
  _debugLog('[iface="wasi:filesystem/types@0.2.6", function="[method]descriptor.symlink-at"][Instruction::Return]', {
...
const trampoline37 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3) {
  var handle1 = arg0;
  var rep2 = handleTable7[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable7.get(rep2);
  if (!rsc0) {
...
const trampoline44 = new WebAssembly.Suspending(async function(arg0, arg1) {
  var handle1 = arg0;
  var rep2 = handleTable7[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable7.get(rep2);
  if (!rsc0) {
...
const trampoline49 = new WebAssembly.Suspending(async function(arg0, arg1, arg2) {
  var handle1 = arg0;
  var rep2 = handleTable2[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable2.get(rep2);
  if (!rsc0) {
...
const trampoline51 = new WebAssembly.Suspending(async function(arg0, arg1, arg2, arg3) {
  var handle1 = arg0;
  var rep2 = handleTable3[(handle1 << 1) + 1] & ~T_FLAG;
  var rsc0 = captureTable3.get(rep2);
  if (!rsc0) {
...
const trampoline56 = new WebAssembly.Suspending(async function(arg0, arg1, arg2) {
  var len3 = arg1;
  var base3 = arg0;
  var result3 = [];
  ...
  _debugLog('[iface="wasi:io/poll@0.2.6", function="poll"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'poll');
  const ret = await poll(result3);
  _debugLog('[iface="wasi:io/poll@0.2.6", function="poll"] [Instruction::CallInterface] (sync, @ post-call)');
  for (const rsc of curResourceBorrows) {
    rsc[symbolRscHandle] = undefined;
  }
  curResourceBorrows = [];
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./stripe-module.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./stripe-module.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ({ exports: exports0 } = yield instantiateCore(yield module2));
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      'stripe:bridge/http-bridge@0.1.0': {
        request: exports0['34'],
        'response-body-read': exports0['36'],
        'response-close': trampoline1,
        'response-headers': exports0['35'],
        'response-status': trampoline0,
      },
      wasi_snapshot_preview1: {
        ...
        fd_fdstat_get: exports0['28'],
        fd_fdstat_set_flags: exports0['29'],
        fd_filestat_get: exports0['17'],
        fd_filestat_set_size: exports0['11'],
        fd_pread: exports0['12'],
        fd_prestat_dir_name: exports0['31'],
        fd_prestat_get: exports0['30'],
        fd_pwrite: exports0['13'],
        fd_read: exports0['14'],
        ...
        path_create_directory: exports0['19'],
        ...
        'random_get [v2]': exports0['8'],
        sched_yield: exports0['0'],
        sock_accept: exports0['32'],
        sock_shutdown: exports0['33'],
      },
    }));
    ({ exports: exports2 } = yield instantiateCore(yield module1, {
      ...
      'wasi:cli/terminal-stderr@0.2.6': {
        'get-terminal-stderr': exports0['75'],
      },
      'wasi:cli/terminal-stdin@0.2.6': {
        'get-terminal-stdin': exports0['73'],
      },
      'wasi:cli/terminal-stdout@0.2.6': {
        'get-terminal-stdout': exports0['74'],
      },
      ...
      'wasi:filesystem/preopens@0.2.6': {
        'get-directories': exports0['67'],
      },
      'wasi:filesystem/types@0.2.6': {
        '[method]descriptor.append-via-stream': exports0['58'],
        '[method]descriptor.create-directory-at': exports0['45'],
        '[method]descriptor.get-flags': exports0['39'],
        '[method]descriptor.get-type': exports0['60'],
        '[method]descriptor.metadata-hash': exports0['56'],
        '[method]descriptor.metadata-hash-at': exports0['57'],
        '[method]descriptor.open-at': exports0['48'],
        '[method]descriptor.read': exports0['41'],
        '[method]descriptor.read-directory': exports0['43'],
        '[method]descriptor.read-via-stream': exports0['53'],
        '[method]descriptor.readlink-at': exports0['55'],
        '[method]descriptor.remove-directory-at': exports0['49'],
        '[method]descriptor.rename-at': exports0['50'],
        '[method]descriptor.set-size': exports0['40'],
        '[method]descriptor.set-times-at': exports0['47'],
        '[method]descriptor.stat': exports0['59'],
        '[method]descriptor.stat-at': exports0['46'],
        '[method]descriptor.symlink-at': exports0['51'],
        '[method]descriptor.sync': exports0['44'],
        '[method]descriptor.unlink-file-at': exports0['52'],
        '[method]descriptor.write': exports0['42'],
        '[method]descriptor.write-via-stream': exports0['54'],
        '[method]directory-entry-stream.read-directory-entry': exports0['37'],
        '[resource-drop]descriptor': trampoline5,
        '[resource-drop]directory-entry-stream': trampoline4,
    ...
    ({ exports: exports3 } = yield instantiateCore(yield module3, {
      '': {
        ...
        '0': exports2.sched_yield,
        '1': exports2.proc_exit,
        '10': exports2.fd_close,
        '11': exports2.fd_filestat_set_size,
        '12': exports2.fd_pread,
        '13': exports2.fd_pwrite,
        '14': exports2.fd_read,
        '15': exports2.fd_readdir,
        '16': exports2.fd_seek,
        '17': exports2.fd_filestat_get,
        '18': exports2.fd_sync,
        '19': exports2.path_create_directory,
        '2': exports2.args_get,
        '20': exports2.path_filestat_get,
        '21': exports2.path_filestat_set_times,
        '22': exports2.path_readlink,
        '23': exports2.path_remove_directory,
        '24': exports2.path_rename,
        '25': exports2.path_symlink,
        '26': exports2.path_unlink_file,
        '27': exports2.path_open,
        '28': exports2.fd_fdstat_get,
        '29': exports2.fd_fdstat_set_flags,
        '3': exports2.args_sizes_get,
        '30': exports2.fd_prestat_get,
        '31': exports2.fd_prestat_dir_name,
        '32': exports2.sock_accept,
        '33': exports2.sock_shutdown,
        '34': trampoline19,
        '35': trampoline20,
        '36': trampoline21,
        '37': trampoline22,
