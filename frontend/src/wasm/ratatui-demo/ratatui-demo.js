...
const trampoline6 = new WebAssembly.Suspending(async function(arg0, arg1, arg2) {
  var handle1 = arg0;
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./ratatui-demo.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./ratatui-demo.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    const module3 = base64Compile('');
