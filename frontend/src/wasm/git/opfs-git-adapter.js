 ...
 */
import { normalizePath, getOpfsDirectory, getOpfsFile, asyncReadFile, asyncWriteFile, listDirectory, fileExistsInOpfs, directoryExistsInOpfs, getOpfsRoot, } from '@tjfontaine/wasi-shims/directory-tree.js';
function createStats(isDir, size, mtime, path) {
    return {
        type: isDir ? 'dir' : 'file',
